...
const ProfilePage: React.FC = () => {
  ...
  const getTransformedPools = () => {
    const transformedPools =  totalPools?.length && totalPools?.map((pool) => ({
      id: pool?.poolId,
      type:"sport",
      imageUrl: "https://th.bing.com/th/id/OIP.bnJRuZujnDtqP6mIVKESjgHaFI?w=248&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7",
  ...
  const mockProfileData = {
    ...
    imageUrl:
      "https://th.bing.com/th?id=OIF.dXw148j%2fh6xvlCxWC0ksCQ&w=154&h=188&c=7&r=0&o=5&dpr=1.3&pid=1.7",
